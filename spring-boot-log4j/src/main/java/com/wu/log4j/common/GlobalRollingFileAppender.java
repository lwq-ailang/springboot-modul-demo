package com.wu.log4j.common;

import com.wu.log4j.util.DateUtils;
...
/**
 * 全局log4j日志输出：按日期记录日志，超过指定大小后记录为新日志文件
 * 1.继承RollingFileAppender
 * 2.然后我们将log4j.properties日志输出appender设为GlobalRollingFileAppender
 *  即log4j.appender.logInfo=com.wu.log4j.common.GlobalRollingFileAppender
 */
